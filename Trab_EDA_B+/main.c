...
int main(void) {
    ...
    printf("\n--- Resumo Final ---\n");
    printf("Registros que deveriam existir e foram encontrados: %d de %d\n", encontrados, index - 100);
    printf("Registros que deveriam ter sido removidos e não foram encontrados: %d de 100\n", nao_encontrados_corretamente);
    ...
    while(1) {
        ...
        if (strcmp(cpf_digitado, "sair") == 0 || (strcmp(cpf_digitado, "SAIR") == 0)) {
            break;
        }
